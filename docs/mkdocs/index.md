...
coordinator can cancel, and the move to LAUNCHED is detected automatically from the chain.

---

## Key concepts

**Committee** — A group of N coordinators, of which M must sign any proposal for it to execute (M-of-N threshold). One
